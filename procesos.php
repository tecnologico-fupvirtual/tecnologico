	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top m-b-0">
			...
			<div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
				...
				<!--<div class="top-left-part"><a class="logo" href="index.html">&emsp;<span class="hidden-xs"><img src="plugins/images/eliteadmin-logo.png" alt="home" /></span></a></div>-->
            ...
            <li> <a href="form-img-cropper.php">Mapa de procesos</a> </li>
					...
					<?php if($_SESSION['administrador']==1){ ?>
                        <li> <a href="#" class="waves-effect"><i class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">SOLICITUDES SGC <span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                <li> <a href="listadoMaestroRegistro">Solicitud de cambio al SGC - FUP</a> </li>
                                <li> <a href="listadoMaestroDocumentos">Reporte No-Conformidad</a> </li>
                                <li> <a href="listadoMaestroDocumentos">Reporte salida No-Conforme</a> </li>
                            </ul>
                        </li>
                    <?php } ?>
								...
								<form action="frmDatos" method="POST">
									...
									<div class="modal-body">                
										...
										<div class="form-group">
											...
											<label for="message-text" class="control-label">Clausulas:</label>

											<textarea class="form-control" id="clausulas" name="clausulas"></textarea>
								...
								<div class="modal-content">
									...
									<div class="modal-body">                
										...
										<div class="form-group">
											...
											<label for="recipient-name" class="control-label">¿Está seguro de eliminar el Proceso?</label>
       ...
       $.ajax({
		...
		var cargar_totales = function(){
			...
			$.ajax({   
				...
				data:{"accion":8,"tabla":"departments","condicion":""},
			...
			$.ajax({   
				...
				data:{"accion":8,"tabla":"departments","condicion":"where departments.soft_delete = 0 and departments.publish = 1"},
			...
			$.ajax({   
				...
				data:{"accion":8,"tabla":"departments","condicion":"where departments.soft_delete = 0 and departments.publish = 0"},
		...
		var obtener_data_editar = function(tbody,table){
			...
			$(tbody).on("click","button.editar",function(){
				...
				clausulas = $("#clausulas").val(data.clauses),
