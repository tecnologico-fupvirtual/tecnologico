                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <label for="recipient-name" class="control-label">¿Está seguro de eliminar el Cargo?</label>
  ...
  <script>
    ...
    var cargar_totales = function(){
      ...
      $.ajax({
        ...
        data:{"accion":8,"tabla":"designations","condicion":""},
      ...
      $.ajax({
        ...
        data:{"accion":8,"tabla":"designations","condicion":"where designations.soft_delete = 0 and designations.publish = 1"},
      ...
      $.ajax({
        ...
        data:{"accion":8,"tabla":"designations","condicion":"where designations.soft_delete = 0 and designations.publish = 0"},
