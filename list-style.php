...
<li> <a href="#" class="waves-effect"><i data-icon="7" class="linea-icon linea-basic fa-fw text-danger"></i> <span class="hide-menu text-danger">MultiPurpose<span class="fa arrow"></span></span></a>
  <ul class="nav nav-second-level two-li">
    ...
    <li> <a href="../eliteadmin-inverse-rtl/index.html">Inverse RTL</a></li>
        ...
        <li> <a href="#" class="waves-effect active"><i data-icon="/" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">UI kit<span class="fa arrow"></span></span></a>
          <ul class="nav nav-second-level two-li">
    ...
    <div class="container-fluid">
      <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4 class="page-title">List & Media Object</h4>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8 p-20">
                    <h3 class="box-title">Media Object</h3>
                     <div class="media">
                        <div class="media-left"> <a href="javascript:void(0)"> <img alt="64x64" class="media-object" src="plugins/images/users/varun.jpg" data-holder-rendered="true" style="width: 64px; height: 64px;"> </a> </div>
                      ...
                      <div class="media">
                        <div class="media-left"> <a href="javascript:void(0)"> <img alt="64x64" class="media-object" src="plugins/images/users/genu.jpg" data-holder-rendered="true" style="width: 64px; height: 64px;"> </a>  </div>
                        <div class="media-body">
                          <h4 class="media-heading">Media heading</h4>
                          Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                          <div class="media">
                            <div class="media-left"> <a href="javascript:void(0)"> <img alt="64x64" class="media-object" src="plugins/images/users/ritesh.jpg" data-holder-rendered="true" style="width: 64px; height: 64px;"> </a> </div>
                            <div class="media-body">
                      ...
                      <div class="media">
                        ...
                        <div class="media-right"> <a href="javascript:void(0)"> <img alt="64x64" class="media-object" src="plugins/images/users/salman.jpg" data-holder-rendered="true" style="width: 64px; height: 64px;"> </a>  </div>
                      </div>
                      <div class="media">
                        <div class="media-left"> <a href="javascript:void(0)"> <img alt="64x64" class="media-object" src="plugins/images/users/varun.jpg" data-holder-rendered="true" style="width: 64px; height: 64px;"> </a> </div>
                        <div class="media-body">
                          <h4 class="media-heading">Media heading</h4>
                          Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. </div>
                        <div class="media-right"> <a href="javascript:void(0)"> <img alt="64x64" class="media-object" src="plugins/images/users/govinda.jpg" data-holder-rendered="true" style="width: 64px; height: 64px;"> </a>  </div>
                      </div>
                </div>
                ...
                <div class="col-md-4 col-sm-4 p-20">
                    ...
                    <div class="list-group">
                      ...
                      <a href="javascript:void(0)" class="list-group-item __web-inspector-hide-shortcut__"> <h4 class="list-group-item-heading">List group item heading</h4> <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. </p> </a>
                      <a href="javascript:void(0)" class="list-group-item __web-inspector-hide-shortcut__"> <h4 class="list-group-item-heading">List group item heading</h4> <p class="list-group-item-text">Maecenas sed diam eget risus varius blandit.</p> </a>
                    </div>
