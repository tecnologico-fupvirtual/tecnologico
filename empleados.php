...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
              ...
              <div class="modal-content">
                ...
                <form action="frmDatos" method="POST">
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      <label for="message-text" class="control-label">Correo electrónico:</label>
                      <input type="email" class="form-control" id="email" name="email" required="true">
                    </div>

                    <div class="form-group"> <!--combobox-->
                      <label for="message-text" class="control-label">Cargo:</label>
                      <div class="combo">
            ...
            <div id="msgeliminar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="form-group">
                      <label for="recipient-name" class="control-label">¿Está seguro de eliminar el Empleado?</label>
                      <input type="hidden" id="id" name="id">
      ...
      <!-- /.container-fluid -->
      <footer class="footer text-center"> <?php echo $año ?> &copy; UNIVIDA </footer>
    </div>
  ...
  <script>
    ...
    var nuevo = function(){
      ...
      $.ajax({
        type: "POST",
        url: "registro_empleados.php",
        data:{"accion":9,"seleccionado":"-1","tabla":"designations","condicion":"where designations.soft_delete = 0 and designations.publish = 1"},
    ...
    var cargar_totales = function(){
      ...
      $.ajax({
        ...
        data:{"accion":8,"tabla":"employees","condicion":""},
      ...
      $.ajax({
        ...
        data:{"accion":8,"tabla":"employees","condicion":"where employees.soft_delete = 0 and employees.publish = 1"},
      ...
      $.ajax({
        ...
        data:{"accion":8,"tabla":"employees","condicion":"where employees.soft_delete = 0 and employees.publish = 0"},
    ...
    var obtener_data_editar = function(tbody,table){
      $(tbody).on("click","button.editar",function(){
        ...
        $.ajax({
          type: "POST",
          url: "registro_empleados.php",
          data:{"accion":9,"seleccionado":data.id_cargo,"tabla":"designations","condicion":"where designations.soft_delete = 0 and designations.publish = 1"},
          success: function(datos)
          {
            $('.combo select').html(datos);
          }
        ...
        email = $("#email").val(data.office_email),
        accion = $("#accion").val("3")
      });
    }
