...
<!--[if lt IE 9]>
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
     <ul class="nav" id="side-menu">
      <li class="sidebar-search hidden-sm hidden-md hidden-lg">
        ...
        <li> <a href="#" class="waves-effect active"><i class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">DATOS DE ENTRADA<span class="fa arrow"></span></span></a> <!-- crea el despliegue y las opc -->
  ...
  <div id="page-wrapper">
            ...
            <div class="modal-content">
              ...
              <form action="frmDatos" method="POST">
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label for="message-text" class="control-label">Proceso:</label>
                    <div class="combo">
        ...
        <div id="msgeliminar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                  <div class="form-group">
                    <label for="recipient-name" class="control-label">¿Está seguro de eliminar la Categoria?</label>
                    <input type="hidden" id="id" name="id">
    ...
    <!-- /.container-fluid -->
    <footer class="footer text-center"> 2022 &copy; UNIVIDA </footer>
  </div>
  <!-- /#page-wrapper -->
</div>
...
<script>
    ...
    var nuevo = function(){
      ...
      $.ajax({
        type: "POST",
        url: "registro_categorias.php",
        data:{"accion":9,"seleccionado":"-1","tabla":"departments","condicion":"where departments.soft_delete = 0 and departments.publish = 1"},
    ...
    var cargar_totales = function(){
      $.ajax({
        type: "POST",
        url:"registro_categorias.php",
        data:{"accion":8,"tabla":"master_list_of_formats","condicion":""},
        success: function(datos){
          $('#ct').html(datos);
        }
      });
      $.ajax({
        type: "POST",
        url:"registro_categorias.php",
        data:{"accion":8,"tabla":"master_list_of_formats","condicion":"where master_list_of_formats.soft_delete = 0 and master_list_of_formats.publish = 1"},
        success: function(datos){
          $('#cp').html(datos);
        }
      });
      $.ajax({
        type: "POST",
        url:"registro_categorias.php",
        data:{"accion":8,"tabla":"master_list_of_formats","condicion":"where master_list_of_formats.soft_delete = 0 and master_list_of_formats.publish = 0"},
        success: function(datos){
          $('#cnp').html(datos);
        }
      });
    ...
    var obtener_data_editar = function(tbody,table){
      $(tbody).on("click","button.editar",function(){
        ...
        type: "POST",
        url: "registro_categorias.php",
        //data:{"accion":9,"seleccionado":data.id_cargo,"tabla":"departments","condicion":"where departments.soft_delete = 0 and departments.publish = 1"},
        data:{"accion":9,"seleccionado":data.id_proceso,"tabla":"departments" ,"condicion":"where departments.soft_delete = 0 and departments.publish = 1"},
        success: function(datos)
        {
          $('.combo select').html(datos);
        }
